...
function About() {
    ...
    let newHTML = `<div class="intro">
        <h1 class="intro-title">Магазин Бытовой техники</h1>
...
<section class="section" id="section">   
        ...
        <div class="section-header">
            <h3 class="section-suptitle">What we do</h3>
            <h2 class="section-title">Story about us</h2>
            <div class="section-text">
                <p> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Similique error optio voluptate perspiciatis laboriosam pariatur sed, adipisci numquam vel magni rem magnam consequuntur quibusdam vero minima ipsa fuga quasi ratione?</p>
            </div>
        </div>
