...
<div class="card-layout">
    ...
    <div class="card">
        ...
        <div class="content-block">
            ...
            <p class="card-description">45.999</p>                    
        </div>
    ...
    <div class="card">
        ...
        <div class="content-block">
            ...
            <p class="card-description">54.999</p>                    
        </div>
        <div class="btns-block">
            <button class="cart">В корзину</button>
            <button class="show">Смотреть</button>
    ...
    <div class="card">
        ...
        <div class="content-block">
            ...
            <p class="card-description">4.888</p>                    
        </div>
        <div class="btns-block">
            <button class="cart">В корзину</button>
            <button class="show">Смотреть</button>
    ...
    <div class="card">
        ...
        <div class="content-block">
            ...
            <p class="card-description">32.999</p>                    
        </div>
        <div class="btns-block">
            <button class="cart">В корзину</button>
            <button class="show">Смотреть</button>
    ...
    <div class="card">
        ...
        <div class="content-block">
            ...
            <p class="card-description">15.777</p>                    
        </div>
        <div class="btns-block">
            <button class="cart">В корзину</button>
            <button class="show">Смотреть</button>
    ...
    <div class="card">
        ...
        <div class="content-block">
            ...
            <p class="card-description">70.444</p>                    
        </div>
        <div class="btns-block">
            <button class="cart">В корзину</button>
            <button class="show">Смотреть</button>
    ...
    <div class="card">
        ...
        <div class="content-block">
            ...
            <p class="card-description">6.787</p>                    
        </div>
        <div class="btns-block">
            <button class="cart">В корзину</button>
            <button class="show">Смотреть</button>
    ...
    <div class="card">
        ...
        <div class="content-block">
            ...
            <p class="card-description">13.555</p>                    
        </div>
        <div class="btns-block">
            <button class="cart">В корзину</button>
            <button class="show">Смотреть</button>
